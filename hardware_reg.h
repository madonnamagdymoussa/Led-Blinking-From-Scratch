...
#ifndef HARDWARE_REG_H_
#define HARDWARE_REG_H_
...
//#define SC_GPIORunModeClockGatingControl  ( *(volatile SC_RCGCGPIO_Reg*)(SYSTEM_CONTROL_BASE + 0x608) )
#define  SC_GPIORunModeClockGatingControl  ( *(volatile u32_t*)(SYSTEM_CONTROL_BASE + 0x608) )

#define SYSCTL_RCGC2_R          (*(volatile u32_t*)(SYSTEM_CONTROL_BASE + 0x108))

#endif /* HARDWARE_REG_H_ */
